...
export default function Home() {
  return (
    <>
      <Head><title>Billward Billing</title><meta name="viewport" content="width=device-width, initial-scale=1" /></Head>
      <main style={{maxWidth: 720, margin: '40px auto', padding: '0 16px', fontFamily: 'system-ui'}}>
        <h1 style={{fontSize: 28, marginBottom: 12}}>Billward – Billing</h1>
        <p>Willkommen! Diese Site startet den Web-Checkout und verwaltet das Abo für Billward Web-Services &amp; Cloud-Funktionen.</p>
